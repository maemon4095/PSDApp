// deno-lint-ignore-file no-empty-pattern ban-types no-explicit-any
...
export default function _dummy(props: { children: preact.ComponentChildren; }): preact.h.JSX.Element;
